...
//     using AngleGeo = PointGeo::Angle;
//     if(algorithm::compare(range, 0.) && (omnibearing == TypeAngle())){
//         return reference_point;
//     }

//     const auto _e2 = eccentricity2_1<Type>();
//     const auto _sinLat = function_angle<AngleGeo>::sin(reference_point.latitude());
//     const auto _os = sqrt(1.0 - _e2 * _sinLat * _sinLat);
//     const auto _sqrtE2 = sqrt(1.0 - _e2);
//     const auto _sinU1 = _sinLat * _sqrtE2 / _os;
//     const auto _cosU1 = function_angle<AngleGeo>::cos(reference_point.latitude()) / _os;
//     const auto _cosOmn = function_angle<TypeAngle>::cos(omnibearing);
//     const auto _sinOmn = function_angle<TypeAngle>::sin(omnibearing);
...
//     const auto _cos2a0 = function_angle<Type>::cos(_a0) * function_angle<Type>::cos(_a0);
...
//     const auto _qD = _q;
//     auto _cos2q1_q = algorithm::determine(_cos2q1, _sin2q1, function_angle<Type>::sin(_q), function_angle<Type>::cos(_q));
//     _q = _qD + _kBA * function_angle<Type>::sin(_q) * _cos2q1_q;
//     _cos2q1_q = algorithm::determine(_cos2q1, _sin2q1, function_angle<Type>::sin(_q), function_angle<Type>::cos(_q));
//     const auto _cos4q1_2q = 2 * _cos2q1_q * _cos2q1_q - 1;
//     _q = _qD + _kBA * function_angle<Type>::sin(_q) * _cos2q1_q + (_kC / _kA) * function_angle<Type>::sin(2 * _q) * _cos4q1_2q;
//     _cos2q1_q = algorithm::determine(_cos2q1, _sin2q1, function_angle<Type>::sin(_q), function_angle<Type>::cos(_q));

//     const auto _cosQ = function_angle<Type>::cos(_q);
//     const auto _sinQ = function_angle<Type>::sin(_q) * _cosOmn;

//     const auto _cosU2 = algorithm::determine(_cosU1, _sinU1, _sinQ, _cosQ);
//     const auto _dY = function_angle<Type>::atan2(function_angle<Type>::sin(_q) * _sinOmn , _cosU2);
//     const auto _sinU2 = algorithm::determine(_sinU1, -_cosU1, _sinQ, _cosQ);

//     const auto latitude = function_angle<Type>::atan(_sinU2 * function_angle<Type>::cos(_dY) / (_sqrtE2 * _cosU2));
//     auto longitude = reference_point.longitude() + _dY - function_angle<Type>::sin(_a0) * ((0.5 + _e2 / 8.0 - (_e2 / 16.0) * _cos2a0)
//                                                                                     * _e2 * _q + _e2 * _e2 * _cos2a0 / 16.0 * function_angle<Type>::sin(_q) * _cos2q1_q);
...
//     using Type = PointGeo::type_coordinate;
//     if(start == stop){
//         return {};
//     }
//     const auto _e2 = eccentricity2_1<TypeAngle>();
//     auto _sinLat = function_angle<Type>::sin(start.latitude());
//     auto _os = sqrt( 1.0 - _e2 * _sinLat * _sinLat );
//     const auto _sinU1 = _sinLat * sqrt( 1.0 - _e2 ) / _os;
//     const auto _cosU1 = function_angle<Type>::cos(start.latitude()) / _os;
//     _sinLat = function_angle<Type>::sin(stop.latitude());
//     _os = sqrt( 1.0 - _e2 * _sinLat * _sinLat );
//     const auto _sinU2 = _sinLat * sqrt( 1.0 - _e2 ) / _os;
//     const auto _cosU2 =  function_angle<Type>::cos(stop.latitude()) / _os;

//     const auto _dL = (stop.longitude() - start.longitude());

//     auto _p = _cosU2 * function_angle<Type>::sin( _dL );
//     auto _q = algorithm::determine(_cosU1, _sinU1, _cosU2 * function_angle<Type>::cos(_dL), _sinU2);
//     auto _n = algorithm::determine(_sinU1, -_cosU1, _cosU2 * function_angle<Type>::cos(_dL), _sinU2);
//     auto _omnibearing = function_angle<Type>::atan2( _p , _q );
//     auto _g = acos( _n );
//     const auto _sinA0 = _cosU1 * function_angle<Type>::sin(_omnibearing);
//     auto _a0 = function_angle<Type>::cos(function_angle<Type>::asin(_sinA0));
//     _a0 *= _a0;
//     const auto _dY = _dL + _sinA0 * ( 0.5 + _e2 / 8.0 - ( _e2 / 16.0 ) * _a0 ) * _e2 * _g;

//     _p = _cosU2 * function_angle<Type>::sin(_dY);
//     _q = algorithm::determine(_cosU1, _sinU1, _cosU2 * function_angle<Type>::cos(_dY), _sinU2);
//     _n = algorithm::determine(_sinU1, -_cosU1, _cosU2 * function_angle<Type>::cos(_dY), _sinU2);
//     _omnibearing = function_angle<Type>::atan2(_p , _q);
//     _g = function_angle<Type>::acos(_n);
//     _a0 = function_angle<Type>::cos(function_angle<Type>::asin(function_angle<Type>::sin(_omnibearing) * _cosU1));
//     _a0 *= _a0;
//     if( _omnibearing < 0 ){
//         _omnibearing += 2 * algorithm::pi<decltype(_omnibearing)>;
//     }
//     const auto _g1 = function_angle<Type>::atan2(_sinU1 , (_cosU1 * function_angle<Type>::cos(_omnibearing)));
...
//                       * function_angle<Type>::sin(_g) * cos( 2 * _g1 + _g ) -
//                   ( _k2_2 / 128.0 ) * semiminor_axis<TypeAngle>
//                       * function_angle<Type>::sin(2 * _g) * cos( 4 * _g1 + 2 * _g );
...
//     return common_survey_comp(point.psi(), point.fi().radian(), reference_poin);
// }
