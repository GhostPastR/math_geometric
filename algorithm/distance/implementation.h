...
template<typename Figure, typename Group, typename CoordinateSystem, std::size_t Dimension>
struct distance{
...
inline constexpr auto distance(const Object1 &a, const Object2 &b){
    ...
    return dispatch::d2::distance<Object1, Object2, tag1, tag2, type_coordinate_system1, dimension1>::get(a,b);
}
...
inline constexpr auto distance(const Figure &figure){
    ...
    return dispatch::d1::distance<Figure, group, type_coordinate_system, dimension>::get(figure);
}
