...
#include "algorithm/convert/implementation_convert.h"
#include "system/traits.h"

namespace agl::algorithm::dispatch::d2::geo_distance {

template<typename Point,
         typename CoordinateSystemGeo,
...
//                 agl::system_coordinat::geo::sc_default,
//                 2>{
//     inline constexpr static auto get(const Point &a, const Point &b){
//         return traits::point::access_point<Point, 0>::get(
//             agl::algorithm::dispatch::geo::convert<Point,
//                                                    Point,
//                                                    agl::system_coordinat::geo::sc_default,
