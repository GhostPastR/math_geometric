...
struct distance<Point,
    ...
    inline constexpr static auto get(const Point &point, const Line &object){
        ...
        return agl::algorithm::dispatch::d2::distance_point_algo::distance<Point, agl::system_coordinat::cartesian, 2>(start, point);
    }
};
...
struct distance<Point,
    ...
    inline constexpr static auto get(const Point &point, const Line &object){
        ...
        return std::min(agl::algorithm::dispatch::d2::distance_point_algo::distance<Point, agl::system_coordinat::cartesian, 2>(start, point),
                        agl::algorithm::dispatch::d2::distance_point_algo::distance<Point, agl::system_coordinat::cartesian, 2>(stop, point));
    }
};
