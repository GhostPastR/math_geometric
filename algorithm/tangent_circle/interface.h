...
//
template<typename LineSectionOut, typename Circle, typename Object, typename TagTangent = agl::algorithm::type_tangent::external>
inline constexpr auto tangent_circle(const Circle &circle, const Object &object, TagTangent tag){
    return geometry::tangent_circle<Circle, Object, LineSectionOut, TagTangent>(circle, object, tag);
}
