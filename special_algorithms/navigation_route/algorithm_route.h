...
// std::vector<figure_route> itinerary_stage(const agl::point2d &prior_start, const agl::point2d &prior_stop,
//                                           const agl::point2d &next_point, double radius){
...
// std::vector<figure_route> through_stage(const agl::point2d &prior_start, const agl::point2d &prior_stop,
//                                         const agl::point2d &next_point, double radius){
//     if(agl::point_algo::is_co_directional(prior_start, prior_stop, next_point)){
//         std::vector<figure_route> figures;
//         figures.push_back({agl::LineSection(prior_stop, next_point)});
...
// std::vector<figure_route> combine_stage(const agl::point2d &prior_start, const agl::point2d &prior_stop,
//                                         const agl::point2d &next_point, double radius1, double radius2,
...
//     auto append_arc = [&](int arc_index, agl::point2d center1, agl::point2d center2, int l_index, direct d1, direct d2, double angle){
